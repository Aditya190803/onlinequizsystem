...
public class OnlineTest extends JFrame implements  ActionListener{
	...
	void set() {
		...
		if (current == 0) {
			label.setText("Que1: What is Spring ?");
			radioButton[0].setText("Markup Language");
			radioButton[1].setText("Pyhon Framework");
			radioButton[2].setText("Java Framework");
			radioButton[3].setText("Programming Language");
		}
		if (current == 1) {
